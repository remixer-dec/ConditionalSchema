...
def test_single_variant_model():
    ...
    print("=" * 60)
    print("Test: Single variant model")
    print("=" * 60)

    class SimpleForm(ConditionalModel):
        name: str
        description: str = CField(when_truthy=["show_desc"])

    # Bind to create single variant
    BoundForm = SimpleForm.bind(show_desc=False)
    ...
    print("\n✓ Single variant model works correctly")
